      ...
      <div className="w-full max-w-[380px] bg-white dark:bg-[#16161D] rounded-2xl shadow-2xl overflow-hidden" onClick={(e) => e.stopPropagation()}>
        ...
        <form onSubmit={handleSubmit}>
          <div className="p-5 space-y-4">
            ...
            <div className="w-full aspect-[9/16] max-h-[360px] rounded-xl overflow-hidden">
              {mode === "image" && preview ? (
                <div className="relative w-full h-full bg-gray-100 dark:bg-gray-800">
                  ...
                  <button type="button" onClick={() => { setFile(null); setPreview(null); setMode("text"); }} className="absolute top-2 right-2 size-7 rounded-full bg-black/60 text-white flex items-center justify-center hover:bg-black/80 z-10"><X className="size-3" /></button>
                </div>
              ) : mode === "text" ? (
            ...
            <Button type="submit" disabled={isPending || (mode === "text" && !content.trim()) || (mode === "image" && !file)}
