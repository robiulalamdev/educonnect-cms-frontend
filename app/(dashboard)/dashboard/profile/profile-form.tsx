    ...
    <div className="grid gap-6 lg:grid-cols-3">
          ...
          <div className="relative inline-block group cursor-pointer" onClick={handleAvatarClick}>
            <Avatar className="size-28 ring-4 ring-[#EFF6FF] dark:ring-blue-950/50">
              {avatarUrl ? (
                ...
                <AvatarFallback className="text-2xl font-bold bg-gradient-to-br from-[#0066FF] to-[#3B82F6] text-white">
                  {initials}
                </AvatarFallback>
              )}
            </Avatar>
      ...
      <Card className="lg:col-span-2 border border-gray-100 dark:border-gray-800 rounded-[24px] bg-white dark:bg-gray-900">
        <CardHeader className="pb-4">
          <CardTitle className="text-lg font-bold text-gray-900 dark:text-white">Personal Information</CardTitle>
        </CardHeader>
        <CardContent className="space-y-5">
          <div className="grid gap-5 sm:grid-cols-2">
            ...
            <div className="space-y-2">
              ...
              <select defaultValue={user.gender || ""} className="w-full rounded-xl h-11 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 px-3 text-sm focus:outline-none focus:ring-2 focus:ring-[#0066FF]/20 focus:border-[#0066FF]">
          ...
          <div className="grid gap-5 sm:grid-cols-3">
            <div className="space-y-2">
              ...
              <Input defaultValue={user.city || ""} placeholder="Dhaka" className="rounded-xl h-11 bg-gray-50 dark:bg-gray-800 border-gray-200 dark:border-gray-700 focus:border-[#0066FF] focus:ring-[#0066FF]/20" />
            </div>
            <div className="space-y-2">
              <Label className="text-[13px] font-medium text-gray-600 dark:text-gray-400">Area</Label>
              <Input defaultValue={user.area || ""} placeholder="Dhanmondi" className="rounded-xl h-11 bg-gray-50 dark:bg-gray-800 border-gray-200 dark:border-gray-700 focus:border-[#0066FF] focus:ring-[#0066FF]/20" />
            </div>
            <div className="space-y-2">
              <Label className="text-[13px] font-medium text-gray-600 dark:text-gray-400">Country</Label>
              <Input defaultValue={user.country || ""} placeholder="Bangladesh" className="rounded-xl h-11 bg-gray-50 dark:bg-gray-800 border-gray-200 dark:border-gray-700 focus:border-[#0066FF] focus:ring-[#0066FF]/20" />
            </div>
          </div>
          <div className="flex justify-end pt-2">
            <Button className="rounded-full bg-[#0066FF] hover:bg-[#0052CC] text-white px-8 h-11 shadow-lg shadow-blue-500/20" disabled={saving}>
              {saving ? <Loader2 className="mr-2 size-4 animate-spin" /> : null}
              Save Changes
            </Button>
          </div>
