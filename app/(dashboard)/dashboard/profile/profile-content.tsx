...
import {
  Loader2, Camera, User, Mail, Phone, MapPin, FileText, AtSign,
        ...
        <Card className="p-0 border border-gray-200/80 dark:border-gray-800/80 rounded-[24px] bg-white dark:bg-[#16161D] overflow-hidden">
          ...
          <div className="grid grid-cols-3 gap-4 px-6 py-5 mt-4 border-t border-gray-100 dark:border-gray-800">
            <div className="text-center">
              <div className="flex size-8 items-center justify-center rounded-lg bg-blue-50 dark:bg-blue-950/50 mx-auto mb-1.5"><BookOpen className="size-4 text-blue-600 dark:text-blue-400" /></div>
              <p className="text-lg font-bold text-gray-900 dark:text-white">12</p>
              <p className="text-[11px] text-gray-500">Courses</p>
            </div>
            <div className="text-center">
              <div className="flex size-8 items-center justify-center rounded-lg bg-green-50 dark:bg-green-950/50 mx-auto mb-1.5"><CheckCircle className="size-4 text-green-600 dark:text-green-400" /></div>
              <p className="text-lg font-bold text-gray-900 dark:text-white">28</p>
              <p className="text-[11px] text-gray-500">Completed</p>
            </div>
            <div className="text-center">
              <div className="flex size-8 items-center justify-center rounded-lg bg-amber-50 dark:bg-amber-950/50 mx-auto mb-1.5"><Award className="size-4 text-amber-600 dark:text-amber-400" /></div>
          ...
          <div className="px-6 pb-4 space-y-3">
            <div className="flex items-center gap-3 p-3 rounded-xl bg-gray-50 dark:bg-gray-800/50">
              <div className="flex size-8 items-center justify-center rounded-lg bg-blue-50 dark:bg-blue-950/50 text-blue-600 dark:text-blue-400"><Mail className="size-4" /></div>
            ...
            <div className="flex items-center gap-3 p-3 rounded-xl bg-gray-50 dark:bg-gray-800/50">
              <div className="flex size-8 items-center justify-center rounded-lg bg-green-50 dark:bg-green-950/50 text-green-600 dark:text-green-400"><Phone className="size-4" /></div>
        ...
        <Card className="border border-gray-200/80 dark:border-gray-800/80 rounded-[24px] bg-white dark:bg-[#16161D]">
          <div className="p-6">
            <div className="flex items-center justify-between mb-5">
              ...
              {saveSuccess && <p className="text-xs text-green-500">Profile updated successfully!</p>}
            </div>
            ...
            <form ref={formRef} onSubmit={handleSave} className="space-y-4">
              ...
              {/* Location Toggle */}
              <div>
                <button type="button" onClick={() => setShowLocation(!showLocation)} className="flex items-center gap-2 text-sm font-semibold text-[#0066FF] hover:text-[#0052CC] transition-colors">
